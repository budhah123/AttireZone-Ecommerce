<%@ Page Title="Khalti Payment Success | AttireZone" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KhaltiSuccess.aspx.cs" Inherits="AttireZone_Web_App.KhaltiSuccess" %>

<asp:Content ID="KhaltiSuccessContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="max-w-4xl mx-auto min-h-[70vh] px-6 py-16 flex items-center justify-center">
        <div class="w-full bg-surface-container p-10 border border-outline-variant/30 text-center space-y-6">
            ...
            <h1 class="text-3xl font-bold uppercase tracking-[0.12em] text-on-background">Khalti Payment Successful</h1>
