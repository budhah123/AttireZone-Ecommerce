...
>
  <style type="text/css">
    ...
    .az-manage-products .az-confirm-modal {
...
>
  ...
  >
                      ...
                      <td class="px-6 py-5 text-right">
                        ...
                        >
                          ...
                          <asp:LinkButton
                            ...
                            CommandArgument='<%#: Eval("Id") %>'
                            CausesValidation="false"
                            OnClientClick='<%# "return showDeleteProductDialog(" + Eval("Id") + ");" %>'
    ...
    <asp:Button
      ID="btnDeleteProductConfirmed"
      runat="server"
      OnClick="btnDeleteProductConfirmed_Click"
      CausesValidation="false"
    ...
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="productDeleteDialogTitle"
      onclick="
  ...
  <script type="text/javascript">
    (function () {
      var dialog = document.getElementById("productDeleteDialog");
      var hiddenId = document.getElementById(
        "<%= hfDeleteProductId.ClientID %>",
      );
      var confirmButton = document.getElementById(
        "<%= btnDeleteProductConfirmed.ClientID %>",
      );

      window.showDeleteProductDialog = function (productId) {
        if (!dialog || !hiddenId) {
          return false;
        }
      ...
      window.closeDeleteProductDialog = function () {
        if (!dialog || !hiddenId) {
          return;
        }
