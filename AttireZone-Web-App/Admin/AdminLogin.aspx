...
<html class="dark" lang="en" xmlns="http://www.w3.org/1999/xhtml">
  ...
  >
    <form id="form1" runat="server">
      ...
      >
        <div
          class="flex justify-between items-center px-6 py-4 w-full max-w-none"
        >
      ...
      <main
        class="min-h-screen flex items-center justify-center pt-20 pb-8 px-5 sm:px-6 relative overflow-hidden"
      >
        ...
        <div class="w-full max-w-sm md:max-w-md z-10">
          <div class="text-center mb-9">
            <span
              class="font-['Inter'] text-[12px] tracking-[0.3em] uppercase text-secondary mb-3 block"
              >Secure Environment</span
            >
            <h1
              class="text-3xl md:text-4xl font-bold tracking-[-0.03em] text-on-surface font-headline leading-tight"
            >
              Executive Portal
            </h1>
            <p
              class="mt-3 text-sm text-on-surface-variant font-light max-w-xs mx-auto"
            >
              Please authenticate to access the AttireZone management console.
            </p>
          </div>

          <div class="bg-surface-container border-0 p-6 md:p-8 relative">
            <div
            ...
            <div class="space-y-7">
              <div class="space-y-2 group">
                ...
                <asp:TextBox
                  ...
                  runat="server"
                  ClientIDMode="Static"
                  CssClass="w-full bg-transparent border-b border-outline-variant/30 py-2.5 text-on-surface placeholder:text-outline-variant/50 focus:border-secondary transition-all duration-500 rounded-none text-sm"
                  MaxLength="150"
              ...
              <div class="space-y-2 group">
                ...
                <div class="relative">
                  <asp:TextBox
                    ...
                    ClientIDMode="Static"
                    TextMode="Password"
                    CssClass="w-full bg-transparent border-b border-outline-variant/30 py-2.5 text-on-surface placeholder:text-outline-variant/50 focus:border-secondary transition-all duration-500 rounded-none text-sm pr-10"
                    MaxLength="80"
                    placeholder="************"
                  ></asp:TextBox>
                  <button
              ...
              <div class="pt-4">
                <asp:Button
                  ...
                  runat="server"
                  Text="Secure Access"
                  CssClass="w-full luxury-gradient text-on-secondary font-bold tracking-[0.1em] uppercase py-3.5 text-sm hover:brightness-110 active:scale-[0.98] transition-all duration-200"
                ...
                <asp:Label
                  ...
                  runat="server"
                  Visible="false"
                  CssClass="block mt-4 text-center text-[10px] tracking-[0.14em] uppercase text-error"
                ></asp:Label>

                <div
                  class="mt-6 flex justify-between items-center text-[10px] tracking-widest uppercase text-on-surface-variant/60"
                >
          ...
          <div class="mt-8 flex justify-center items-center gap-6 opacity-20">
            <div class="h-[1px] w-10 bg-outline-variant"></div>
      ...
      >
        <div
          class="flex flex-col items-center justify-center py-9 px-6 w-full gap-6"
        >
